...
while game_on and rounds > 0:
    ...
    if len(user_guess) == len(set(user_guess)) and user_guess[0] != "0" and len(user_guess) == 4:
        rounds -=  1
        for i, n in enumerate(str(user_guess)):
        ...
        if user_guess == secret_number:
            ...
            print("You have failed to guess a secret number :-(")
            game_on = False
    else:
